	...
	<div class="limiter">
		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form method="post" class="login100-form validate-form" action="<?php echo base_url('home/createAccount') ?>">
...
<?php endif; ?>
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="number" name="mobaile_number" placeholder="Mobalie Number">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					...
					<div class="text-center">
						...
						<a href="<?php echo base_url('home/signin') ?>" class="txt2 hov1">
							Sign in
						</a>
					</div>
				</form>
